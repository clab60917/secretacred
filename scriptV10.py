...
def is_excluded(row, excluded_departments, excluded_emails):
...
filtered_data_c3 = filtered_data_c3[~filtered_data_c3.apply(lambda row: is_excluded(row, excluded_departments, excluded_emails), axis=1)]
...
# Appliquer les nouvelles règles d'exclusion
filtered_data_elr = filtered_data_elr[~filtered_data_elr.apply(lambda row: is_excluded(row, excluded_departments, excluded_emails), axis=1)]
...
# Étape 4 : Application des autres filtres
