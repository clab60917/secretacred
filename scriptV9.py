...
filtered_data_c3 = filtered_data_c3[~filtered_data_c3.apply(is_excluded, axis=1)]
...
# Appliquer les nouvelles règles d'exclusion
filtered_data_elr = filtered_data_elr[~filtered_data_elr.apply(is_excluded, axis=1)]
