...
# Appliquer les nouvelles règles d'exclusion pour ELR
...
# Appliquer les nouvelles règles d'exclusion générales
filtered_data_c3 = filtered_data_c3[~filtered_data_c3.apply(lambda row: is_excluded(row, excluded_departments, excluded_emails, set()), axis=1)]
print("\n---------------\nAperçu des données filtrées après exclusion (départements C3)...\n---------------")
print("Premières lignes de 'filtered_data_c3' après exclusion:\n", filtered_data_c3.head())

# Étape 4 : Filtrage selon 'LIST C3 DPT ALL TYPES'
...
# Appliquer les nouvelles règles d'exclusion pour 'ALL TYPES'
...
# Étapes de filtrage
print("\nÉtapes de filtrage :")
print("1. Synchronisation des données entre 'people' et 'custom'.")
print("2. Filtrage selon 'LIST C3 DPT ONLY INTERNALS'.")
print("3. Filtrage selon 'LIST OF ELR'.")
print("4. Application des nouvelles règles d'exclusion (ELR).")
print("5. Application des nouvelles règles d'exclusion (générales).")
print("6. Filtrage selon 'LIST C3 DPT ALL TYPES'.")
print("7. Filtrage selon 'NOMINATIVE USERS'.")
print("8. Filtre final : exclusion des utilisateurs avec 'Absents' dans STATUS_GROUP_LABEL.")
